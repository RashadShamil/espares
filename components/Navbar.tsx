      ...
      <div className={`w-full transition-all duration-400 ${scrolled ? 'px-4 pt-3 pb-3' : 'px-0 py-0'}`}>
        <nav className={`mx-auto flex items-center gap-4 lg:gap-6 transition-all duration-400 ${
          ...
          <div className="flex items-center gap-1.5 ml-auto">
            ...
            {/* Wishlist — desktop only when logged in */}
            {isLoggedIn && (
              <Link href="/wishlist" className="hidden md:block p-2.5 rounded-xl hover:bg-gray-100 text-gray-600 hover:text-red-500 transition-colors">
            ...
            {isLoggedIn ? (
              <div className="flex items-center gap-1">
                {/* Account pill — avatar always, name only on md+ */}
                <Link href="/account" className="flex items-center gap-2 px-2 py-1.5 rounded-xl border border-gray-200 hover:border-brand-green/30 hover:bg-brand-green/5 transition-all">
              ...
              <Link href="/login" className="bg-brand-green text-white text-sm font-semibold px-4 py-2.5 rounded-xl hover:bg-brand-green-light transition-colors shadow-sm">
                Sign In
              </Link>
            )}
